...
class Environment {
  ...
  //static String apiURL = Platform.isAndroid ? 'http://192.168.18.98:3001/api':'http:/192.168.18.98:3001/api';
  //static String socketURL = Platform.isAndroid ? 'http://192.168.18.98:3001/api':'http:/192.168.18.98:3001/api';
}